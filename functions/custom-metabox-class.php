		...
		foreach ( $this->_meta_box['fields'] as $field ) {
			...
			switch ( $field['type'] ) {
				...
				case 'text':
					...
					break;
				case 'text_small':
					echo '<div class="cmb_text_small_wrapper"><input class="cmb_text_small" type="text" name="', $field['id'], '" id="', $field['id'], '" value="', '' !== $meta ? $meta : $field['std'], '" /><span class="cmb_metabox_description">', $field['desc'], '</span></div>';
					break;
				case 'text_medium':
					echo '<div class="cmb_text_medium_wrapper"><input class="cmb_text_medium" type="text" name="', $field['id'], '" id="', $field['id'], '" value="', '' !== $meta ? $meta : $field['std'], '" /><span class="cmb_metabox_description">', $field['desc'], '</span></div>';
					break;
				case 'text_date':
				...
				case 'address':
					echo '<p><input type="text" id="', $field['id'], 'address_line_1" id="', $field['id'], ' value="', '' !== $meta ? $meta : $field['std'], '" /><span class="cmb_metabox_description" >Address Line 1</span><p>';
					echo '<p><input type="text" id="', $field['id'], 'address_line_2" id="', $field['id'], ' value="', '' !== $meta ? $meta : $field['std'], '" /><span class="cmb_metabox_description" >Address Line 2</span></p>';
					echo '<p><div class="cmb_text_medium_wrapper"><input class="cmb_text_medium" type="text" id="', $field['id'], 'city" id="', $field['id'], ' value="', '' !== $meta ? $meta : $field['std'], '" /><span class="cmb_metabox_description" >City</span></div><div class="cmb_text_small_wrapper"><input class="cmb_text_small" type="text" id="', $field['id'], 'state" id="', $field['id'], ' value="', '' !== $meta ? $meta : $field['std'], '" /><span class="cmb_metabox_description" >State</span> </div><div class="cmb_text_small_wrapper"><input class="cmb_text_small" type="text" id="', $field['id'], 'zip" id="', $field['id'], ' value="', '' !== $meta ? $meta : $field['std'], '" /><span class="cmb_metabox_description" >Zip Code</span></div></p>';
					break;
...
function cmb_scripts( $hook ) {
  	if ( $hook == 'post.php' || $hook == 'post-new.php' || $hook == 'page-new.php' || $hook == 'page.php' ) {
		...
		wp_register_script( 'cmb-scripts', CMB_META_BOX_URL . 'js/custom-metabox-class.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-datepicker', 'media-upload', 'thickbox', 'farbtastic' ), '0.9.1' );
		...
		wp_register_style( 'cmb-styles', CMB_META_BOX_URL . 'css/custom-metabox-class.css', array( 'thickbox', 'farbtastic' ) );
